...
#    root.inputPaths = ('C:/Users/zq/Downloads/七里香.mp3',)
#    root.export_path_var.set('C:/Users/zq/Downloads')
#    root.chosen_process_method_var.set(MDX_ARCH_TYPE)
#    root.vr_model_var.set('MDX23C-InstVoc_HQ')
#    root.process_start()
    ...
    file_name, extension = os.path.splitext(song_name)
    print("process separate")
    root.demucs_stems_var.set(VOCAL_STEM)
    root.is_primary_stem_only_var.set(True)
    root.is_secondary_stem_only_var.set(False)
    root.inputPaths = ('C:/Users/zq/Downloads/'+song_name,)
    root.export_path_var.set('C:/Users/zq/Downloads')
    root.chosen_process_method_var.set(DEMUCS_ARCH_TYPE)
    root.vr_model_var.set('htdemucs_ft')
    root.process_start()
    print("complete separate")

    print("preprocess vocal dechorus")
    root.is_primary_stem_only_var.set(False)
    root.is_secondary_stem_only_var.set(True)
    root.inputPaths = ('C:/Users/zq/Downloads/1_'+ file_name +'_(Vocals).wav',)
    root.export_path_var.set('C:/Users/zq/Downloads')
    root.chosen_process_method_var.set(VR_ARCH_PM)
    root.vr_model_var.set('6_HP-Karaoke-UVR')
    root.process_start()
    print("complete vocal dechorus")

    print('preprocess dereverb')
    root.is_primary_stem_only_var.set(True)
    root.is_secondary_stem_only_var.set(False)
    root.inputPaths = ('C:/Users/zq/Downloads/1_1_'+ file_name +'_(Vocals)_(Vocals).wav',)
    root.export_path_var.set('C:/Users/zq/Downloads')
    root.chosen_process_method_var.set(VR_ARCH_PM)
    root.vr_model_var.set('UVR-DeEcho-DeReverb')
    root.process_start()
    print("complete dereverb")